...
class __TwigTemplate_75d25e6f035b9c16a2cb302e7de3ed647556d81eca180e83245826edd897fffd extends \Twig\Template
{
  ...
  <form method=\"post\">
    ...
    ";
       ...
       ";
            // line 11
            echo twig_escape_filter($this->env, (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 11, $this->source); })()), "html", null, true);
            echo "
      </div>
    ";
        }
...
";
    ...
    {
        return array (  108 => 16,  104 => 14,  98 => 11,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container\">
  <form method=\"post\">
    ...
    <div class=\"form-group\">
      <label for=\"inputUsername\">login</label>
      <input type=\"text\" name=\"_username\" value=\" {{ lastUsername}}\" id= \"inputUsername\" class=\"form-control\" placeholder=\"login\" required autofocus>
    </div>
    <div class=\"form-group\">
      <label for=\"inputPassword\">Password</label>
      <input type=\"password\" name=\"_password\" id=\"inputPassword\" class=\" form-control\" placeholder=\"Password\" required>
...
{% endblock %}
", "home/index.html.twig", "C:\\data\\tjaulin\\Projet\\GSB\\templates\\home\\index.html.twig");
    }
}
